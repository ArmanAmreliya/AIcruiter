...
export const FeaturesSection = () => {
  return (
    <section
      id="features"
      className="py-24 relative z-10 bg-gray-50 dark:bg-black"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-16 text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Everything you need to automate first-round interviews
          </h2>
          <p className="text-gray-500 dark:text-gray-400 text-lg">
            From candidate voice interviews to AI-generated evaluation reports,
            AIcruiter gives hiring teams a faster, more scalable screening
            workflow.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 pb-20">
              <div className="relative w-48 h-48 rounded-2xl bg-gradient-to-tr from-purple-100 to-white dark:from-purple-900/30 dark:to-zinc-800 border border-purple-200 dark:border-purple-500/30 flex items-center justify-center shadow-inner overflow-hidden">
                <FileText
                  size={64}
                  className="text-purple-400 dark:text-purple-500 opacity-50"
                />
            ...
            <div className="relative z-20">
              <h3 className="text-2xl font-bold mb-2">AI Evaluation Reports</h3>
              <p className="text-gray-500 dark:text-gray-400">
                Turn every completed interview into structured summaries, match
                insights, and recruiter-ready decision support.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 pb-20">
              <div className="relative w-full px-12">
                <svg
                  viewBox="0 0 400 100"
                  className="w-full h-32 stroke-purple-400 dark:stroke-purple-500 fill-none stroke-[2]"
                ...
                >
                  ...
                  <line
                    ...
                    y2="20"
                    strokeDasharray="4"
                    className="stroke-purple-200 dark:stroke-zinc-700 stroke-[1]"
                  />
                  <line
                    x1="0"
                    y1="80"
                ...
                >
                  ...
                  <div className="text-xs">
                    <p className="font-semibold mb-0.5">
                      I’ve led API design for high-scale products...
                    </p>
            ...
            <div className="relative z-20">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Capture each candidate response live so recruiters never lose
                context, even across high-volume interview pipelines.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-20">
              <h3 className="text-2xl font-bold mb-2">
                Candidate-Centered Interview Tracking
              </h3>
              <p className="text-gray-500 dark:text-gray-400">
                Keep every response organized by candidate and role so feedback
                stays reviewable, structured, and easy to compare.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-20">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Designed with tokenized audio access, pooled database
                connections, and production-ready serverless infrastructure.
              </p>
            </div>
          </motion.div>
        </div>
