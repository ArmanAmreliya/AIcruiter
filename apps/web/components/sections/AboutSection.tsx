        ...
        >
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-zinc-600 dark:text-zinc-400 mb-8 max-w-lg">
              AIcruiter automates first-round voice screening so recruiters can
              identify top candidates faster, reduce manual effort, and keep
              hiring decisions consistent.
            </p>

            <button
              data-landing-button="true"
              onClick={() => router.push("/signup")}
              className="bg-[#7C3AED] hover:bg-[#6D28D9] text-white px-8 py-3 rounded-md font-medium transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl active:scale-[0.99] flex items-center group"
            >
          ...
          >
            ...
            <div className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-zinc-100 dark:border-zinc-800 p-6 animate-float">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-semibold text-lg">Today Interviews</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-zinc-500">11:15AM - 11:45AM</p>
                  </div>
                ...
                <div className="flex items-center gap-4 p-3 rounded-lg bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-500/20">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm truncate text-purple-900 dark:text-purple-100">
                      Product Manager Voice Interview
                    </p>
                ...
                <div className="flex items-center gap-4 p-3 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm truncate">
                      Customer Success Candidate Review
                    </p>
                    <p className="text-xs text-zinc-500">05:10PM - 05:40PM</p>
                  </div>
                  <div className="p-2 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-400">
                    <Video size={16} />
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 lg:mt-0">
            {[
              { icon: User, text: "Human-first candidate experience" },
              {
                icon: PieChart,
                text: "Consistent scoring across every screen",
              },
              { icon: Lock, text: "Privacy-conscious architecture" },
              { icon: Globe, text: "Built for distributed hiring" },
            ].map((feature, idx) => (
              <motion.div
                key={idx}
                variants={{
