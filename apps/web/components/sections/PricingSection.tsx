  ...
  const plans = [
    {
      ...
      description:
        "For recruiters and early-stage teams launching AI screening",
      features: [
        "Up to 25 candidate interviews/month",
        "AI interview summaries",
        "Role-based screening setup",
    ...
    },
    {
      ...
      description: "For hiring teams running high-volume interview pipelines",
      features: [
    ...
    },
    {
      ...
      price: "Custom",
      description:
        "For enterprise hiring organizations with security and workflow requirements.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-8 tracking-tight">
            Simple pricing for{" "}
            <span className="text-[#6D28D9]">high-performing</span> hiring teams
          </h2>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Choose a plan that matches your interview volume, collaboration
            needs, and hiring workflow complexity.
          </p>
            ...
            >
              ...
              <p
                className={cn(
                  ...
                  plan.isPremium ? "text-gray-400" : "text-gray-600",
                )}
              >
                {plan.description}
              </p>
                  ...
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm">
                      <CheckCircle2
                        ...
                        className={cn(
                          "shrink-0 mt-0.5",
                          plan.isPremium ? "text-[#6D28D9]" : "text-black",
                        )}
                        fill={plan.isPremium ? "currentColor" : "none"}
                      />
                      <span
                        className={
              ...
              <button
                ...
                className={cn(
                  "w-full py-3 rounded-full font-bold text-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl active:scale-95",
                  plan.isPremium
                    ? "bg-[#6D28D9] text-white hover:bg-[#5b21b6]"
                    : "bg-black text-white hover:bg-gray-800",
                )}
              >
                Start with AIcruiter ›
              </button>
            </motion.div>
          ))}
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-500 text-sm font-medium mb-8">
            Built for recruiters who need faster screening, better signal, and
            less manual work.
          </p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-40 grayscale">
            ...
            <div className="text-xl font-bold font-serif italic">HireStack</div>
            <div className="text-xl font-bold font-mono">SCREENLAB</div>
            <div className="text-xl font-extrabold tracking-widest">
              PEOPLEOPS
            </div>
            <div className="text-xl font-bold font-sans tracking-tight hidden md:block">
              TalentFlow
            </div>
            <div className="text-xl font-bold font-serif italic hidden md:block">
              HireStack
            </div>
          </div>
        </div>
