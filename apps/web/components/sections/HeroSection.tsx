  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <Badge>AI voice screening for modern hiring teams</Badge>
        </motion.div>
        ...
        >
          ...
          <span className="inline-flex align-middle mx-2 p-2 bg-white dark:bg-white/10 rounded-2xl shadow-lg border border-gray-100 dark:border-white/5 rotate-[-2deg] hover:rotate-0 transition-transform duration-300">
            <img
              src="https://img.icons8.com/glyph-neue/64/6D28D9/online-support.png"
              alt="Bot"
          ...
          <span className="inline-flex align-middle mx-2 p-2 bg-white dark:bg-white/10 rounded-2xl shadow-lg border border-gray-100 dark:border-white/5 rotate-[2deg] hover:rotate-0 transition-transform duration-300">
            <img
              src="https://img.icons8.com/ios-filled/50/6D28D9/microphone--v1.png"
              alt="Mic"
        ...
        >
          Run real-time voice interviews, screen candidates at scale, and get
          structured hiring reports automatically. AIcruiter helps recruiters
          move faster without losing signal, context, or candidate experience.
        </motion.p>
        ...
        >
          ...
          <Button
            data-landing-button="true"
            variant="outline"
            className="w-full sm:w-auto h-12 px-8 text-lg group"
            onClick={() => router.push("/login")}
          >
            <Play size={16} className="mr-2 fill-current" />
            See the interview flow
          </Button>
        </motion.div>
